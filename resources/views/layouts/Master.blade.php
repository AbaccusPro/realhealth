    ...
    <div class="page-container ">
      ...
      <div class="header ">
          ...
          <div class="pull-center hidden-md hidden-lg">
            <div class="header-inner">
              <div class="brand inline">
                <img src="{{asset('styles/assets/img/logo_white.png')}}" alt="logo" data-src="{{asset('styles/assets/img/logo_white.png')}}" data-src-retina="{{asset('styles/assets/img/logo_white.png')}}" width="95" height="23">
              </div>
            </div>
          </div>
          <!-- RIGHT SIDE -->
        ...
        <div class=" pull-left sm-table hidden-xs hidden-sm">
          <div class="header-inner">
            <div class="brand inline">
              <img src="{{asset('styles/assets/img/logo_2x.png')}}" alt="logo" data-src="{{asset('styles/assets/img/logo_2x.png')}}" data-src-retina="{{asset('styles/assets/img/logo_2x.png')}}" width="40%">
            </div>
                        ...
                        <div class="notification-item unread clearfix">
                          <div class="heading">
                            <div class="thumbnail-wrapper d24 circular b-white m-r-5 b-a b-white m-t-10 m-r-10">
                              <img width="30" height="30" data-src-retina="{{asset('styles/assets/img/profiles/1x.jpg')}}" data-src="{{asset('styles/assets/img/profiles/1.jpg')}}" alt="" src="{{asset('styles/assets/img/profiles/1.jpg')}}">
                            </div>
                            <a href="#" class="text-complete pull-left">
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        ...
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{asset('styles/assets/img/profiles/1x.jpg')}}" data-src="{{asset('styles/assets/img/profiles/1.jpg')}}" src="{{asset('styles/assets/img/profiles/1x.jpg')}}" class="col-top">
                        </span>
                        </span>
                  ...
                  <ul>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{asset('styles/assets/img/profiles/2x.jpg')}}" data-src="{{asset('styles/assets/img/profiles/2.jpg')}}" src="{{asset('styles/assets/img/profiles/2x.jpg')}}" class="col-top">
                        </span>
                        </span>
                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{asset('styles/assets/img/profiles/3x.jpg')}}" data-src="{{asset('styles/assets/img/profiles/3.jpg')}}" src="{{asset('styles/assets/img/profiles/3x.jpg')}}" class="col-top">
                        </span>
                        </span>
                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
                  ...
                  <ul>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{asset('styles/assets/img/profiles/4x.jpg')}}" data-src="{{asset('styles/assets/img/profiles/4.jpg')}}" src="{{asset('styles/assets/img/profiles/4x.jpg')}}" class="col-top">
                        </span>
                        </span>
                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{asset('styles/assets/img/profiles/5x.jpg')}}" data-src="{{asset('styles/assets/img/profiles/5.jpg')}}" src="{{asset('styles/assets/img/profiles/5x.jpg')}}" class="col-top">
                        </span>
                        </span>
                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
                  ...
                  <ul>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="col-xs-height col-middle">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{asset('styles/assets/img/profiles/6x.jpg')}}" data-src="{{asset('styles/assets/img/profiles/6.jpg')}}" src="{{asset('styles/assets/img/profiles/6x.jpg')}}" class="col-top">
                        </span>
                        </span>
                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
    ...
    <div class="overlay hide" data-pages="search">
      ...
      <div class="overlay-content has-results m-t-20">
        ...
        <div class="container-fluid">
          <!-- BEGIN Overlay Logo !-->
          <img class="overlay-brand" src="{{asset('styles/assets/img/logo_white.png')}}" alt="logo" data-src="{{asset('styles/assets/img/logo_white.png')}}" data-src-retina="{{asset('styles/assets/img/logo_white.png')}}" width="78" height="22">
          <!-- END Overlay Logo !-->
          <!-- BEGIN Overlay Close !-->
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="">
                  ...
                  <div class="p-l-10 inline p-t-5">
                    <h5 class="m-b-5"><span class="semi-bold result-name">aml compliance</span> on pages</h5>
                ...
                <div class="">
                  ...
                  <!-- END Search Result Item Thumbnail !-->
                  <div class="p-l-10 inline p-t-5">
                    <h5 class="m-b-5"><span class="semi-bold result-name">aml compliance</span> related topics</h5>
                ...
                <div class="">
                  ...
                  <!-- END Search Result Item Thumbnail !-->
                  <div class="p-l-10 inline p-t-5">
                    <h5 class="m-b-5"><span class="semi-bold result-name">aml compliance</span> music</h5>
              ...
              <div class="col-md-6">
                ...
                <div class="">
                  ...
                  <!-- END Search Result Item Thumbnail !-->
                  <div class="p-l-10 inline p-t-5">
                    <h5 class="m-b-5"><span class="semi-bold result-name">aml compliance</span> on facebook</h5>
                ...
                <div class="">
                  ...
                  <!-- END Search Result Item Thumbnail !-->
                  <div class="p-l-10 inline p-t-5">
                    <h5 class="m-b-5">Tweats on<span class="semi-bold result-name"> aml compliance</span></h5>
                ...
                <div class="">
                  ...
                  <!-- END Search Result Item Thumbnail !-->
                  <div class="p-l-10 inline p-t-5">
                    <h5 class="m-b-5">Circles on<span class="semi-bold result-name"> aml compliance</span></h5>
